...
public class PlaybackControlView extends FrameLayout {
  ...
  public PlaybackControlView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    if (playButton != null) {
      ...
      playButton.setOnFocusChangeListener(componentListener);
    }
    pauseButton = findViewById(R.id.exo_pause);
    if (pauseButton != null) {
      pauseButton.setOnClickListener(componentListener);
      pauseButton.setOnFocusChangeListener(componentListener);
    }
    previousButton = findViewById(R.id.exo_prev);
    if (previousButton != null) {
      previousButton.setOnClickListener(componentListener);
      previousButton.setOnFocusChangeListener(componentListener);
    }
    nextButton = findViewById(R.id.exo_next);
    if (nextButton != null) {
      nextButton.setOnClickListener(componentListener);
      nextButton.setOnFocusChangeListener(componentListener);
    }
    rewindButton = findViewById(R.id.exo_rew);
    if (rewindButton != null) {
      rewindButton.setOnClickListener(componentListener);
      rewindButton.setOnFocusChangeListener(componentListener);
    }
    fastForwardButton = findViewById(R.id.exo_ffwd);
    if (fastForwardButton != null) {
      fastForwardButton.setOnClickListener(componentListener);
      fastForwardButton.setOnFocusChangeListener(componentListener);
    }
  }
  ...
  private final class ComponentListener implements ExoPlayer.EventListener,
      SeekBar.OnSeekBarChangeListener, OnClickListener, OnFocusChangeListener {
    ...
    public void onFocusChange(View view, boolean hasFocus) {
      if (player != null) {
        ...
        fastForwardButton.setBackgroundColor(Color.TRANSPARENT);
        rewindButton.setBackgroundColor(Color.TRANSPARENT);
        ...
        if (nextButton == view) {
          ...
          previousButton.setBackgroundColor(Color.BLUE);
        } else if (fastForwardButton == view) {
          fastForwardButton.setBackgroundColor(Color.BLUE);
        } else if (rewindButton == view) {
          rewindButton.setBackgroundColor(Color.BLUE);
        } else if (playButton == view) {
