...
public final class ParsableByteArray {
  ...
  public String readLine() {
    ...
    //SuperTV change to support UTF and ISO chars
    String line = new String(data, position, lineLimit - position, Charset.forName("UTF-8"));
    if(line.indexOf('\uFFFD') != -1) {
      line = new String(data, position, lineLimit - position, Charset.forName("ISO-8859-1"));
    }
//    String line = new String(data, position, lineLimit - position, Charset.forName("ISO-8859-1"));
//    Charset.forName("ISO-8859-1").newEncoder().canEncode("string");
    position = lineLimit;
    if (position == limit) {
      return line;
    }
